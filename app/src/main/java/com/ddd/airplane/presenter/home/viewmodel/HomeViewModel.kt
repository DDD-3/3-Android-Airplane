    ...
    fun getHomeList() {
        ...
        val recent = ArrayList<ChatRoomData>().apply {
            ...
            add(
                ChatRoomData(
                    ...
                    subjectThumbnailUrl = "http://img.cgv.co.kr/Movie/Thumbnail/Poster/000082/82999/82999_320.jpg"
                )
            )
            ...
            add(
                ChatRoomData(
                    ...
                    subjectThumbnailUrl = "http://img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83039/83039_320.jpg"
                )
            )
            ...
            add(
                ChatRoomData(
                    ...
                    subjectSubscribeCount = 10,
                    subjectThumbnailUrl = "http://img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83004/83004_320.jpg"
                )
            )
        }
        itemList.add(
        ...
        val rank = ArrayList<ChatRoomData>().apply {
            ...
            add(
                ChatRoomData(
                    roomUserCount = 10,
                    subjectName = "스파이 지니어스",
                    subjectDescription = "잘나가는 슈퍼 스파이! \n" +
                    ...
                    subjectSubscribeCount = 10,
                    subjectThumbnailUrl = "http://img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83000/83000_320.jpg"
                )
            )
            ...
            add(
                ChatRoomData(
                    roomUserCount = 10,
                    subjectName = "해치지않아",
                    subjectDescription = "“사자? 호랑이? 공룡? 다~ 됩니다!”\n" +
                            "쫄지마! 티 안나! 털 날리며, 당당하게!\n" +
                            "\n" +
                    ...
                    subjectSubscribeCount = 10,
                    subjectThumbnailUrl = "http://img.cgv.co.kr/Movie/Thumbnail/Poster/000082/82985/82985_320.jpg"
                )
            )
        }
        itemList.add(
